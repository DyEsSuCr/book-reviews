    ...
    <div className='grid grid-cols-3'>
      {books.items.map(book => (
        <figure key={book.id}>
          ...
          <img className='object-cover w-52 h-52' src={book.volumeInfo.imageLinks?.thumbnail ?? 'https://www.salonlfc.com/wp-content/uploads/2018/01/image-not-found-1-scaled-1150x647.png'} alt={book.volumeInfo.title} />
